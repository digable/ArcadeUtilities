...
namespace ArcadeUtilitiesConsole
{
    class Program
    {
        ...
        {
            if(args.Contains("launchbox") || args.Length == 0)
            {
                //find parameters and values
                //-convert 1610 | -convert 169
                //probably need to get screen resolution
                Functions.LaunchBox.UpdateArtworkRatios();
                Functions.MAME.UpdateScreenResolution();
            }

            if (args.Contains("ledblinky"))
            {
